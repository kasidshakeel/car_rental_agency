<?php
    ...
    $query = "select * from vehicles where book = 0 && agency = '$agency_id'";
...
<body>
    ...
    <div class="welcome-section">
        <div class="container">
            <h1><i>Your Vehicle For Rent</i></h1>
            <p>List of Your Available Cars. Check and Update the Cars Info!</p>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col">
                <div class="card items">
                    <img class="img-responsive card-img-top" src="<?php echo $row['images']; ?>" alt="Card image cap" width="100px" height="150px">
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <?php
                        if ($row['book'] == 1) { ?>
                            <button class="card-link btn btn-outline-alert" disabled>Booked</button>
                        <?php
                        }
                        else {?>
