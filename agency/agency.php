<?php
    ...
    $query = "select * from vehicles where agency='$agency_id'";
...
<body>
    ...
    <div class="welcome-section">
        <div class="container">
            <h1>Yours All Vehicles</h1>
            <p>List of Booked and Available Cars. Check and Update the Cars Info for better service!</p>
        </div>
    </div>
